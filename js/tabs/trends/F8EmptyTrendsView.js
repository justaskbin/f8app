...
class F8EmptyTrendsView extends React.Component {
  static defaultProps = {
    onPress: _ => {}
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <Text style={styles.text}>
            F8 2017 trends will be added here on the evening of Day 1.
          </Text>
          <F8Button
            theme="bordered"
            opacity={0.5}
            caption="Watch F8 2016 Trends"
...
/* Exports
============================================================================= */
export default F8EmptyTrendsView;

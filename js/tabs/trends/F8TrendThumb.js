...
* @param {?String} length Trend length
* @param {?String} image Thumbnail image source
* @param {?Boolean} watched Has trend already been watched by user
* @param {?Number} activeOpacity On-tap opacity value (default 0.75)
* @return {ReactElement}
* ==============================================================================
*/

class F8TrendThumb extends React.Component {
  static defaultProps = {
    type: "small",
    activeOpacity: 0.75
  };
